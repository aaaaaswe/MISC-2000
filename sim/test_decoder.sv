...
module tb_decoder;
    ...
    initial begin
        ...
        // Boundary: last Data Transfer opcode (offset=255, 255%5=0 → IMM, dtype=(255%20)/5=3→Q)
        ...
        // AND.B.IMM at 0x408: offset=0, addr=0(IMM), type=0(B)
        test_opcode("AND.B.IMM  (0x408) first-logic",
            12'h408, 4'd2, 3'd0, 3'd0, 8'd0, 1'b0, 1'b1, 1'b1);

        // NOT.W.IMM: offset=65, addr=65%5=0(IMM), type=(65%20)/5=1(W)
        test_opcode("NOT.W.IMM (0x449)",
            12'h449, 4'd2, 3'd0, 3'd1, 8'd0, 1'b0, 1'b1, 1'b1);

        // XOR.D.STK: offset=166, addr=166%5=1(REG), type=(166%20)/5=1(W)
        test_opcode("XOR.D.STK  (0x4AE)",
            12'h4AE, 4'd2, 3'd1, 3'd1, 8'd0, 1'b0, 1'b1, 1'b1);

        // Last valid Logic opcode: 0x4F7 (BITIN.Q.STK), offset=239, addr=239%5=4(STK), type=(239%20)/5=3(Q)
        test_opcode("Logic last (0x4F7)",
            12'h4F7, 4'd2, 3'd4, 3'd3, 8'd0, 1'b0, 1'b1, 1'b1);

        // post-logic: 0x4F8-0x4FF are reserved (invalid), 0x4F8 is first invalid after Logic
        test_opcode("post-logic  (0x4F8) invalid",
            12'h4F8, 4'd0, 3'd0, 3'd0, 8'd0, 1'b0, 1'b0, 1'b0);
        ...
        test_opcode("PC first    (0x62C)",
            12'h62C, 4'd4, 3'd4, 3'd0, 8'd0, 1'b0, 1'b1, 1'b1);

        // JMP.IMM: offset=0x40=64, addr=4(STK)
        test_opcode("JMP.IMM     (0x640)",
            12'h640, 4'd4, 3'd4, 3'd0, 8'd0, 1'b0, 1'b1, 1'b1);
        ...
        test_opcode("PC boundary (0x6FF)",
            12'h6FF, 4'd4, 3'd0, 3'd0, 8'd0, 1'b0, 1'b1, 1'b1);
        ...
        test_opcode("SYS (0x800)",
            12'h800, 4'd6, 3'd0, 3'd0, 8'd0, 1'b0, 1'b0, 1'b1);

        test_opcode("SYS (0x880)",
            12'h880, 4'd6, 3'd0, 3'd0, 8'd0, 1'b0, 1'b0, 1'b1);

        test_opcode("SYS last (0x9FF)",
            12'h9FF, 4'd6, 3'd0, 3'd0, 8'd0, 1'b0, 1'b0, 1'b1);
